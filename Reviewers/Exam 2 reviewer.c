...
CLOSED HASHING
NOTE: if u dont know how to do cursor based check the guide at the end of the page it miiiiiight help
...
/* Bonus if u dont know how to do cursor based, might be a lil diff but fundamentally the same
Cursor Balls adt
typedef struct{
